...
public class AwesomeMqtt implements MqttCallbackExtended {
  ...
  public AwesomeMqtt(@NonNull final String ref, final ReactApplicationContext reactContext, final ReadableMap options) {
    clientRef = ref;
